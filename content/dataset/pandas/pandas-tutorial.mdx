...
<CollapsibleCodeCell code={`print("결측치 있는 행:", df.isnull().any(axis=1).sum())`} />
...
<CollapsibleCodeCell code={`print("3. 이름 A로 시작:", name_a['Name'].tolist())`} />
...
<CollapsibleCodeCell code={`print("3. 도시-부서별 직원 수:", city_dept_count)`} />
